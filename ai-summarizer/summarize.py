...
---
<sub>🤖 Generated by AI Risk Summarizer · Powered by Claude · <a href="https://github.com/{os.environ.get('REPO', 'your-org/your-repo')}/actions/runs/{os.environ.get('GITHUB_RUN_ID', '')}">View workflow run</a></sub>
"""
    return comment
